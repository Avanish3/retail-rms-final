...
const swaggerSpec = (0, swagger_jsdoc_1.default)({
    definition: {
        ...
        info: {
            ...
            version: "1.0.0",
            description: "Backend API for an enterprise-ready Retail Management System covering auth, inventory, POS, orders, reports, notifications, audit logs, and AI insights."
        },
        servers: [
            {
